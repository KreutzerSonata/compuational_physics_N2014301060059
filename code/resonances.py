...
#plot
figure(figsize=[8,8])
scatter(x_e,y_e,s=1,color='blue',label='Asteroid')
plot(x_j,y_j,color='orange',label='Jupiter')
...
ax.plot(x_e,y_e,t,color='blue',label='Asteroid')
ax.plot(x_j,y_j,t,color='orange',label='Jupiter')
legend(loc='upper left')
ax.set_xlabel('x/AU')
ax.set_ylabel('y/AU')
ax.set_zlabel('t/yr')
